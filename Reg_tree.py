...
train_mse = skmetrics.mean_squared_error(Y_train, Y_train_pred)
test_mse = skmetrics.mean_squared_error(Y_test, Y_test_pred)
print(f"Tree Train MSE: {train_mse:.4f}")
print(f"Tree Test MSE: {test_mse:.4f}")